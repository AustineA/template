class PostsController < ApplicationController
  ...
  def search
    ...
    @posts =  Post.search query, order: { score: :desc, promotion_updated_at: :desc}, fields: [{lga: :exact}, {state: :exact}, {area: :exact}, {tags: :exact}, :reference_id], where: args, aggs: { purpose: {}, type_of_property: {}, use_of_property: {}, price: {}, bedrooms: {}, bathrooms: {}, state:{}, lga:{}}, page: params[:page], per_page: 8
    render :index
